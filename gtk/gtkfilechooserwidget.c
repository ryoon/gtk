...
file_list_drag_begin_cb (GtkWidget            *widget,
                         ...
                         GtkFileChooserWidget *impl)
{
  gtk_places_sidebar_set_drop_targets_visible (GTK_PLACES_SIDEBAR (impl->priv->places_sidebar), TRUE);
}
                       ...
                       gpointer        user_data)
{
  ...
  gtk_places_sidebar_set_drop_targets_visible (GTK_PLACES_SIDEBAR (impl->priv->places_sidebar), FALSE);
}
